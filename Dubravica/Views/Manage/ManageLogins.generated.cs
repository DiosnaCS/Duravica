...
namespace ASP
{
    ...
    public partial class _Views_Manage_ManageLogins_cshtml : System.Web.Mvc.WebViewPage<Dubravica.Models.ManageLoginsViewModel>
    {
...
WriteAttribute("title", Tuple.Create(" title=\"", 1720), Tuple.Create("\"", 1786)
, Tuple.Create(Tuple.Create("", 1728), Tuple.Create("Remove", 1728), true)
, Tuple.Create(Tuple.Create(" ", 1734), Tuple.Create("this", 1735), true)
            
            #line 40 "..\..\Views\Manage\ManageLogins.cshtml"
                                          , Tuple.Create(Tuple.Create(" ", 1739), Tuple.Create<System.Object, System.Int32>(account.LoginProvider
            
            #line default
            #line hidden
, 1740), false)
, Tuple.Create(Tuple.Create(" ", 1762), Tuple.Create("login", 1763), true)
, Tuple.Create(Tuple.Create(" ", 1768), Tuple.Create("from", 1769), true)
, Tuple.Create(Tuple.Create(" ", 1773), Tuple.Create("your", 1774), true)
, Tuple.Create(Tuple.Create(" ", 1778), Tuple.Create("account", 1779), true)
);
...
WriteAttribute("id", Tuple.Create(" id=\"", 2624), Tuple.Create("\"", 2650)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
, Tuple.Create(Tuple.Create("", 2629), Tuple.Create<System.Object, System.Int32>(p.AuthenticationType
...
WriteAttribute("value", Tuple.Create(" value=\"", 2667), Tuple.Create("\"", 2696)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
                                        , Tuple.Create(Tuple.Create("", 2675), Tuple.Create<System.Object, System.Int32>(p.AuthenticationType
...
WriteAttribute("title", Tuple.Create(" title=\"", 2697), Tuple.Create("\"", 2741)
, Tuple.Create(Tuple.Create("", 2705), Tuple.Create("Log", 2705), true)
, Tuple.Create(Tuple.Create(" ", 2708), Tuple.Create("in", 2709), true)
, Tuple.Create(Tuple.Create(" ", 2711), Tuple.Create("using", 2712), true)
, Tuple.Create(Tuple.Create(" ", 2717), Tuple.Create("your", 2718), true)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
                                                                                       , Tuple.Create(Tuple.Create(" ", 2722), Tuple.Create<System.Object, System.Int32>(p.Caption
            
            #line default
            #line hidden
, 2723), false)
, Tuple.Create(Tuple.Create(" ", 2733), Tuple.Create("account", 2734), true)
);
